...
class NullosCrudGenerator extends CrudGenerator
{
    ...
    private function generateDataTableProfileManual($db, $table)
    {
        ...
        $dst = Z::appDir() . "/config/datatable-profiles/" . $this->module . "/manual/$db/$table.php";
        /**
...
//        $dstManual = Z::appDir() . "/class-prc/$module/$Db/$Table" . "PersistentRowCollection.php";
//        if (!file_exists($dstManual)) {
//            $namespace = 'namespace Prc\AutoAdmin\\' . $Db . ';' . PHP_EOL;
//            $tags['//-namespace'] = $namespace;
//            $c = str_replace(array_keys($tags), array_values($tags), $content);
//            FileSystemTool::mkfile($dstManual, $c);
//        }
